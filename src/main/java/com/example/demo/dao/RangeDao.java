...
public class RangeDao {
	...
	public int insert(RangeEntity ent) {
		...
		jdbcTemplate.update(connection -> {
			...
			ps.setBoolean(3, ent.getMonday());
			ps.setBoolean(4, ent.getTuesday());
			ps.setBoolean(5, ent.getWednesday());
			ps.setBoolean(6, ent.getThursday());
			ps.setBoolean(7, ent.getFriday());
			ps.setBoolean(8, ent.getSaturday());
			ps.setBoolean(9, ent.getSunday());
			ps.setBoolean(10, ent.getHoliday());
			return ps;
		}, keyHolder);
